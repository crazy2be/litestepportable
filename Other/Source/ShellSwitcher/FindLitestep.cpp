...
void CreateSettingsini() {
    ...
    "PortableAppsDir=E:\\PortableApps\\\n"
    "; the path to the popup file to write the portableapps info to\n"
    "PortableApps popup file=E:\\PortableApps\\App\\LiteStep\\Personal\\PortableApps.rc\n"
    "; The path to the lsxcommand alias file\n"
    "PortableApps LSX file=E:\\PortableApps\\App\\LiteStep\\Personal\\LSXCommand\\PortableApps.rc\n"
    "; The path to the desktop folder\n"
    "DesktopFolderPath=E:\\PortableApps\\App\\Litestep\\Personal\\Desktop\\\n"
    ...
    "Litestep=E:\\PortableApps\\App\\Litestep\\Litestep.exe\n"
